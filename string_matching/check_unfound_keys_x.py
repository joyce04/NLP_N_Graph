...
def get_side_effects():
    ...
    # select_sql = """select distinct(lower(llt_name)) from meddra_llt_180717 WHERE exclude=0 AND lower(llt_name)>='v'AND lower(llt_name)<'w' order by lower(llt_name)"""
